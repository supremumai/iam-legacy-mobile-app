    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#0a0900' }}>
      ...
      >
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 24 }}>
          <Text style={{ fontFamily: Fonts.playfair700, fontSize: 24, color: '#c9a84c' }}>Education</Text>
          <Text style={{ fontFamily: Fonts.inter400, fontSize: 14, color: '#6B7280', marginTop: 2 }}>Learn and grow</Text>
        </View>
        ...
        <View style={{ marginHorizontal: 20, marginTop: 24, borderRadius: 16, backgroundColor: '#1c1a14', borderWidth: 1, borderColor: 'rgba(201,168,76,0.22)', height: 160, overflow: 'hidden', justifyContent: 'space-between', padding: 20 }}>
          <View>
            <Text style={{ fontFamily: Fonts.inter600, fontSize: 11, color: '#c9a84c', letterSpacing: 1.5, textTransform: 'uppercase' }}>
              Featured Course
            </Text>
            <Text style={{ fontFamily: Fonts.playfair900, fontSize: 20, color: '#FFFFFF', marginTop: 4 }}>
              Build Your Brand 101
            </Text>
            <Text style={{ fontFamily: Fonts.inter400, fontSize: 13, color: '#6B7280', marginTop: 2 }}>
              with Marcus Reid
            </Text>
          </View>
          <View style={{ flexDirection: 'row', gap: 16 }}>
            <Text style={{ fontFamily: Fonts.inter400, fontSize: 12, color: '#FFFFFF' }}>12 lessons</Text>
            <Text style={{ fontFamily: Fonts.inter400, fontSize: 12, color: '#FFFFFF' }}>4.9 ★</Text>
          </View>
        </View>

        {/* Categories */}
        <View style={{ marginTop: 24 }}>
          <Text style={{ paddingHorizontal: 20, fontFamily: Fonts.playfair700, fontSize: 18, color: '#c9a84c' }}>Browse by Category</Text>
          <ScrollView
            horizontal
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 24 }}>
          <Text style={{ fontFamily: Fonts.playfair700, fontSize: 18, color: '#c9a84c' }}>All Courses</Text>
            ...
            {COURSES.map((course) => (
              ...
              >
                ...
                <View style={{ paddingHorizontal: 16, paddingVertical: 12 }}>
                  <Text style={{ fontFamily: Fonts.inter700, fontSize: 16, color: '#FFFFFF' }}>{course.title}</Text>
                  <Text style={{ fontFamily: Fonts.inter400, fontSize: 13, color: '#6B7280', marginTop: 2 }}>{course.instructor}</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8, gap: 10 }}>
                    <Text style={{ fontFamily: Fonts.inter400, fontSize: 12, color: '#6B7280' }}>{course.lessons}</Text>
                    <Text style={{ fontFamily: Fonts.inter400, fontSize: 12, color: '#6B7280' }}>{course.rating}</Text>
                    <View style={{ backgroundColor: course.badgeBg, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 2 }}>
                      <Text style={{ fontFamily: Fonts.inter600, fontSize: 11, color: course.badgeText }}>{course.badge}</Text>
                    </View>
                  </View>
                </View>
              </View>
        ...
        {/* Continue Learning */}
        <View style={{ paddingHorizontal: 20, marginTop: 24 }}>
          <Text style={{ fontFamily: Fonts.playfair700, fontSize: 18, color: '#c9a84c' }}>Continue Learning</Text>
          <View style={{ marginTop: 12, gap: 12 }}>
            {PROGRESS_COURSES.map((item) => (
              ...
              >
                <Text style={{ fontFamily: Fonts.inter700, fontSize: 15, color: '#FFFFFF' }}>{item.title}</Text>
                ...
                <Text style={{ fontFamily: Fonts.inter400, fontSize: 12, color: '#6B7280', marginTop: 6 }}>{item.percent}% complete</Text>
              </View>
            ))}
          </View>
        </View>
